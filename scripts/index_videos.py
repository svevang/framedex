...
def _coerce_people_count(value: Any, face_count: int) -> int:
...
def describe_frames_cli(
    ...
    if any(t in lower for t in permission_telltales) and len(text_out) < 600:
